namespace Restuaracja
{
    partial class OrdersView
    {
        ...
        private void InitializeComponent()
        {
            ...
            // Sprawdz
            // 
            Sprawdz.Anchor = AnchorStyles.Bottom;
            Sprawdz.BackColor = Color.FromArgb(2, 8, 29);
            Sprawdz.Font = new Font("Arial Narrow", 11.25F, FontStyle.Bold, GraphicsUnit.Point, 238);
            Sprawdz.ForeColor = Color.FromArgb(225, 187, 130);
            Sprawdz.Location = new Point(710, 397);
            Sprawdz.Margin = new Padding(0);
            Sprawdz.Name = "Sprawdz";
            Sprawdz.Size = new Size(75, 50);
            Sprawdz.TabIndex = 6;
            Sprawdz.Text = "Zamow";
