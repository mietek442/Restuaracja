    ...
    public partial class AddDish : UserControl
    {
        ...
        private async void buttonSendData_ClickAsync(object sender, EventArgs e)
        {
            if (!string.IsNullOrEmpty(uploadedImageId))
            {
                ...
                using (var client = new System.Net.Http.HttpClient())
                {
                    var response = await client.PostAsync($"{ApiBaseUrl}/dishes", content);
        ...
        private void InitializeComponent()
        {
            ...
            label1.Font = new Font("Arial Narrow", 25F, FontStyle.Bold);
            ...
            shortDescLabel.Size = new Size(83, 16);
            ...
            fullDescLabel.Size = new Size(63, 16);
            ...
            isAvailableLabel.Font = new Font("Arial Narrow", 9.25F, FontStyle.Bold);
            isAvailableLabel.Location = new Point(382, 244);
            isAvailableLabel.Name = "isAvailableLabel";
            isAvailableLabel.Size = new Size(58, 16);
            ...
            priceLabel.Font = new Font("Arial Narrow", 9.25F, FontStyle.Bold);
            priceLabel.Location = new Point(382, 284);
            priceLabel.Name = "priceLabel";
            priceLabel.Size = new Size(34, 16);
            ...
            discountPriceLabel.Font = new Font("Arial Narrow", 9.25F, FontStyle.Bold);
            discountPriceLabel.Location = new Point(382, 324);
            discountPriceLabel.Name = "discountPriceLabel";
            discountPriceLabel.Size = new Size(61, 16);
            ...
            cuisineLabel.Font = new Font("Arial Narrow", 9.25F, FontStyle.Bold);
            cuisineLabel.Location = new Point(382, 364);
            cuisineLabel.Name = "cuisineLabel";
            cuisineLabel.Size = new Size(51, 16);
